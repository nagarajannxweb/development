...
class DSR(Document):   
	def validate_calculation(self):
		...
		cash_deposit_amount = self.pos_cash_sale + self.advance_cash+self.virtual_store_cash_sale
		...
		virtual_store_sale = self.virtual_store_cash_sale+self.virtual_store_other_modes_sale
		self.virtual_store_sale = virtual_store_sale
